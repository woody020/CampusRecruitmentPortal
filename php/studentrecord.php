          ...
          for($i=1;$i<=$rowss;$i++)
          {
            ...
            <tr>
              <td align="center">
                ...
                <input style="width:110px; background-color: transparent;border: 0;font-size: 1em;" readonly type="text" name="search" value=<?php echo $out['roll']; ?> >
              ...
              <td align="center">
                ...
                <form action="" method="post">
                  <input readonly type="email" name="email" value=<?php echo $out['email']; ?>></td>
                <td align="center">
                  <input style="width: 110px;" readonly type="text" name="roll" value=<?php echo $out['roll']; ?>>
                <input type="submit" value="Delete" name="del"></td>
...
<?php
  ...
  <center>  <a class="fa fa-arrow-circle-left" href="http://localhost/php/companyregister.php">BACK</a></center>
