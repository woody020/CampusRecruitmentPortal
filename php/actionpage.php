...
<body>
		...
		$num=0;
			...
			$q="SELECT * from resgistration1 where username='$uname' and roll='$roll' and password='$psw'";
			...
			else if($num>0)
			{
				...
				<form id="ahead" action="#">
					...
					function ahead()
					{
						document.getElementById('ahead').action='http://localhost/php/studentview1.php';
